            ...
            <section class="space-y-3" aria-label="Notes">
                <?php $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="rounded-xl border border-slate-700/80 bg-slate-800/60 p-4">
                        <a href="<?php echo e(route('notes.edit', $note)); ?>" class="block active:opacity-80">
                            ...
                            <p class="mt-2 text-xs text-slate-500"><?php echo e($note->updated_at->diffForHumans()); ?></p>
                        </a>
                    </article>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/stuart/PhpstormProjects/halfshellstudios-academy/using-native-php/6-on-device-databases-and-offline-data/chapter-project-offline-notes-crud/resources/views/notes/index.blade.php ENDPATH**/ ?>