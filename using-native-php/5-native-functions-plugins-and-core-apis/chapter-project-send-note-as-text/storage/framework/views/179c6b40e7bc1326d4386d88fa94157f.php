...
<?php $component = Native\Mobile\Edge\Components\Navigation\BottomNavItem::resolve(['id' => 'home','icon' => 'home','label' => 'Home','url' => ''.e(route('home')).'','active' => request()->routeIs('home')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal65e79709cc5dd13bb051ccf5036e597d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal65e79709cc5dd13bb051ccf5036e597d = $attributes; } ?>
<?php $component = Native\Mobile\Edge\Components\Navigation\BottomNavItem::resolve(['id' => 'compose','icon' => 'edit','label' => 'Compose','url' => ''.e(route('compose')).'','active' => request()->routeIs('compose')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('native-bottom-nav-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php /**PATH /Users/stuart/PhpstormProjects/halfshellstudios-academy/using-native-php/5-native-functions-plugins-and-core-apis/chapter-project-send-note-as-text/resources/views/layouts/app.blade.php ENDPATH**/ ?>