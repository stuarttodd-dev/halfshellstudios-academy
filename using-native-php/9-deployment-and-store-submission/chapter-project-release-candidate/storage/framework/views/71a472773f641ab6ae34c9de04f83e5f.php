<div class="mt-6 rounded-xl border border-slate-700/80 bg-slate-800/40 p-4">
    ...
    <dl class="mt-3 space-y-2 text-xs">
        <div class="flex justify-between gap-4">
            ...
            <dd class="text-slate-300"><?php echo e($permission ?? 'unknown'); ?></dd>
        </div>
        <div class="flex justify-between gap-4">
            <dt class="text-slate-500">Token</dt>
            <dd class="font-mono text-slate-400"><?php echo e($tokenPreview ?? 'Not enrolled'); ?></dd>
        </div>
    </dl>
...
<?php /**PATH /Users/stuart/PhpstormProjects/halfshellstudios-academy/using-native-php/9-deployment-and-store-submission/chapter-project-field-notes-release-candidate/resources/views/livewire/push-enrollment.blade.php ENDPATH**/ ?>