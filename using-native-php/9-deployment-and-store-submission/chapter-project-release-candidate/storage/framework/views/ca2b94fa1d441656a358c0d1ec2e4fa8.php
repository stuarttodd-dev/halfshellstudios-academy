<div class="mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-5 text-center">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($failed): ?>
    ...
    <a href="<?php echo e(route('settings')); ?>" class="mt-4 text-sm text-slate-500 underline-offset-2 hover:text-slate-300 hover:underline">
        Settings
    </a>
</div>
<?php /**PATH /Users/stuart/PhpstormProjects/halfshellstudios-academy/using-native-php/9-deployment-and-store-submission/chapter-project-field-notes-release-candidate/resources/views/livewire/unlock-gate.blade.php ENDPATH**/ ?>