...
<?php $component = Native\Mobile\Edge\Components\Navigation\BottomNavItem::resolve(['id' => 'home','icon' => 'home','label' => 'Home','url' => ''.e(route('notes.index')).'','active' => request()->routeIs('notes.index', 'notes.show')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /Users/stuart/PhpstormProjects/halfshellstudios-academy/using-native-php/9-deployment-and-store-submission/chapter-project-field-notes-release-candidate/resources/views/layouts/app.blade.php ENDPATH**/ ?>