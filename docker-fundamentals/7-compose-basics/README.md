# Chapter 7 — Compose basics

**Course chapter:** [Compose basics](https://docker.learnio.dev/learn/sections/chapter-compose-basics/)

Example code for chapter 7 lessons.

| Lesson | Folder |
| ------ | ------ |
| nginx and PHP-FPM in Compose | [compose-two-service](compose-two-service/) (`compose.yaml`) |
